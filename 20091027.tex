...
\begin{enumerate}
 ...
 \item $x<y \implies \sqrt[n]x < \sqrt[n]y$
 \item $0<x<1, m<n \implies \sqrt[m]{x} < \sqrt[n]{x}$
 \item $x>1, m<n \implies \sqrt[m]x > \sqrt[n]x$
 \item $\sqrt[n]{x^n} = \begin{cases} x & n \text{ ungerade} \\ |x| & n \text{ gerade} \end{cases}$
\end{enumerate}
\induction\\
gegen Ende der Vorlesung: $x > 0, \alpha \in \mathbb{R} \implies x^\alpha := \euler^{\alpha \operatorname{ln}(x)}$
