...
Deutung für das Produkt 2er komplexer Zahlen:
\begin{align*}
...
\paragraph{Formel von Moivre (Potenzbildung)}
\begin{align*}
	z &= |z|(\cos \varphi + \imag \sin \varphi) \\
...
Rückwärst gelesen als "Wurzel ziehen"
\begin{align*}
...
\paragraph*{Graphen:}
\textit{[Die Graphen von Sinus und Kosinus sollten bekannt sein (Anm. d. Verf.).]}
