...
(2,0) node (a2) {} node[uplabel] {$a_2$} node[downlabel] {2}
(3,0) node (a3) {} node[uplabel] {$a_3$} node[downlabel] {3};
\foreach \n in {a1,a2,a3}
\draw (\n) ++(0,-0.1) -- ++(0,0.2);
\end{tikzpicture}
...
\end{tikzpicture}
	...
	\item $a_n = \frac{1}{n}$: $a_1 = 1, a_2 = \frac{1}{2}, a_3 = \frac{1}{3}, \ldots$
...
(3,0) node (a1) {} node[uplabel] {$a_1$} node[downlabel] {1}
(2,0) node (a2) {} node[uplabel] {$a_2$} node[downlabel] {$\frac{1}{2}$}
(1.66,0) node (a3) {} node[uplabel] {$a_3$} node[downlabel] {$\frac{1}{3}$};
\foreach \n in {n0, a1,a2,a3}
\draw (\n) ++(0,-0.1) -- ++(0,0.2);
\end{tikzpicture}
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
...
\draw (0.5,0) -- (3.5,0)
(1,0) node (a1) {} node[uplabel] {$a_1$}  node[downlabel] {-1}
(3,0) node (a2) {} node[uplabel] {$a_2$} node[downlabel] {1};
\foreach \n in {a1,a2}
\draw (\n) ++(0,-0.1) -- ++(0,0.2);
\end{tikzpicture}
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]
...
Im Beispiel 2 ist es der 0-Wert: $a_n \rightarrow 0$.

\paragraph{Zentrale Werkzeuge}
	\begin{itemize}
	\item Schranken
	\item Monotonie
\end{itemize}
